...
TNodoCalendario::TNodoCalendario(const TNodoCalendario &obj): c(obj.c){
...
TNodoCalendario & TNodoCalendario::operator=(const TNodoCalendario &obj){
    if(this != &obj){   //Controlamos la autoasignación
